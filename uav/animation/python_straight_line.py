...
1. Copyright of this Python fileis owned by the author: Mark Misin
...
that indicate that the Copyright is owned by Mark Misin MUSTNOT be removed.
...
invention, or whatever it is used for fails - the author is NOTRESPONSIBLE!
'''
